...
message2 = Message('Departamento de Computacion y Sistemas', 3, 58, "../retro-galaxy/src/fonts/font1.otf", 15, 'white',1)
...
message5 = Message('Escuela de Ingenieria', 3, 39, "../retro-galaxy/src/fonts/font1.otf", 15, 'white',1)
message6 = Message('Nucleo Anzoategui', 3, 20, "../retro-galaxy/src/fonts/font1.otf", 15, 'white',1)
